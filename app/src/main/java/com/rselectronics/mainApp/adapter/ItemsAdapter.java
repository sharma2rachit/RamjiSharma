package com.rselectronics.mainApp.adapter;
...
import com.rselectronics.mainApp.activity.TrackerDetailActivity;
...
import com.rselectronics.mainApp.model.OrderTracker;

import static com.rselectronics.mainApp.activity.TrackerDetailActivity.pBar;
...
public class ItemsAdapter extends RecyclerView.Adapter<ItemsAdapter.CartItemHolder> {
    ...
    public void onBindViewHolder(final CartItemHolder holder, final int position) {
        ...
        holder.imgorder.setDefaultImageResId(R.drawable.cart_logo);
        holder.imgorder.setErrorImageResId(R.drawable.cart_logo);
